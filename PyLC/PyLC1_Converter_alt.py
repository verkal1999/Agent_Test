...
def parse_pou_blocks(xml_path: str, output_path: str = "generated_code_0.py") -> None:
    """
    Liest eine PLCopen-XML-Datei und extrahiert alle POU- und Blockinformationen.
    Schreibt die Daten in ein Python-Skript (intermediate file), das später von generator.py importiert wird.
    
    Args:
        xml_path: Pfad zur export.xml aus TwinCAT.
        output_path: Zielpfad für die erzeugte Python-Datei (z. B. 'generated_code_0.py').
    """
